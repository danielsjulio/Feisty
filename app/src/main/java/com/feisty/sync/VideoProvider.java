 ...
 */
public class VideoProvider extends android.content.ContentProvider {
    ...
    static {
        sUriMatcher.addURI(AUTHORITY, "videos", ROUTE_ENTRIES);
        sUriMatcher.addURI(AUTHORITY, "videos/*", ROUTE_ENTRIES_ID);
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case ROUTE_ENTRIES:
                long id = db.insertOrThrow(Contacts.Video.TABLE_NAME, null, values);
    ...
    static class FeedDatabase extends SQLiteOpenHelper {
        ...
        /** SQL statement to drop "video" table. */
        private static final String SQL_DELETE_ENTRIES =
                "DROP TABLE IF EXISTS " + Contacts.Video.TABLE_NAME;
